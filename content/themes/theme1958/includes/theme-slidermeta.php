...
$meta_box_slider = array(
	...
	'title' =>  __('Slider Options', 'theme1958'),
	'page' => 'slider',
	'context' => 'normal',
	'priority' => 'high',
	'fields' => array(
		array(
			'name' => __('Caption', 'theme1958'),
			'desc' => __('Input your caption for slide (HTML tags are allowed). ', 'theme1958'),
		...
		array(
			...
			'desc' => __('Input the slide URL (can be external link)', 'theme1958'),
...
function my_show_box_slider() {
	...
	echo '<p style="padding:10px 0 0 0;">'.__('Please fill additional fields for slide. ', 'theme1958').'</p>';
