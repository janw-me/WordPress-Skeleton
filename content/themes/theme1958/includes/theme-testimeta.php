...
$meta_box_testi = array(
	...
	'title' =>  __('Testimonial Options', 'theme1958'),
	'page' => 'testi',
	'context' => 'normal',
	'priority' => 'high',
	'fields' => array(
		array(
			'name' => __('Name', 'theme1958'),
			'desc' => __('Input author\'s name. ', 'theme1958'),
			'id' => $prefix . 'testi_caption',
			'type' => 'text',
			'std' => ''
		),
		array(
			'name' => __('URL', 'theme1958'),
			'desc' => __('Input author\'s URL.', 'theme1958'),
			'id' => $prefix . 'testi_url',
			'type' => 'text',
			'std' => ''
		),
		array(
			'name' => __('Info', 'theme1958'),
			'desc' => __('Input author\'s additional info.', 'theme1958'),
...
function my_show_box_testi() {
	...
	echo '<p style="padding:10px 0 0 0;">'.__('Please fill additional fields for testimonial. ', 'theme1958').'</p>';
