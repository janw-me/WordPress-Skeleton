	...
	function form($instance) {				
		...
		<p>
			<label for="<?php echo $this->get_field_id('img1'); ?>">
				<?php _e('1st banner path:', 'theme1958'); ?> 
		...
		<p>
			<label for="<?php echo $this->get_field_id('url1'); ?>">
				<?php _e('1st banner Link:', 'theme1958'); ?> 
		...
		<p>
			<label for="<?php echo $this->get_field_id('img2'); ?>">
				<?php _e('2nd banner path:', 'theme1958'); ?> 
		...
		<p>
			<label for="<?php echo $this->get_field_id('url2'); ?>">
				<?php _e('2nd banner Link:', 'theme1958'); ?> 
		...
		<p>
			<label for="<?php echo $this->get_field_id('img3'); ?>">
				<?php _e('3rd banner path:', 'theme1958'); ?> 
		...
		<p>
			<label for="<?php echo $this->get_field_id('url3'); ?>">
				<?php _e('3rd banner Link:', 'theme1958'); ?> 
		...
		<p>
			<label for="<?php echo $this->get_field_id('img4'); ?>">
				<?php _e('4th banner path:', 'theme1958'); ?> 
		...
		<p>
			<label for="<?php echo $this->get_field_id('url4'); ?>">
				<?php _e('4th banner Link:', 'theme1958'); ?> 
