...
class MY_PostsTypeWidget extends WP_Widget {
	...
	function widget($args, $instance) {
		...
		if($instance['container_class']==""){
			...
			echo "<ul class='post_list rlist " .$instance['container_class'] ."'>\n";
		}
		...
		if ( $instance['global_link'] ) : ?>
			<a href="<?php echo $instance['global_link_href']; ?>" class="button link_show_all"><?php if($instance['global_link_text']==""){ ?>View all<?php }else{ ?><?php echo $instance['global_link_text']; ?><?php } ?></a>
		<?php endif;
