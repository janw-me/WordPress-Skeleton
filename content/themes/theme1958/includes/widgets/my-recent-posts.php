				...
				<li class="clearfix">
					<div class="clearfix">
						<?php if(has_post_thumbnail()) {
							...
							$image = aq_resize( $img_url, 65, 65, true ); //resize & crop img ?>
						...
						<div class="extra-wrap">
							...
							<h6><a href="<?php the_permalink() ?>" rel="bookmark" title="<?php _e('Permanent Link to', 'theme1958');?> <?php the_title_attribute(); ?>"><?php the_title(); ?></a></h6>
						</div>
					</div>
					...
					<a href="<?php the_permalink() ?>" class="link"><?php _e('Read more', 'theme1958'); ?></a>
				</li>
			<?php endwhile; endif;?>
		</ul>
	...
	function form($instance) {
		...
		<p>
			<label for="<?php echo $this->get_field_id('title'); ?>">
				<?php _e('Title:', 'theme1958'); ?>
				<input class="widefat" id="<?php echo $this->get_field_id('title'); ?>" name="<?php echo $this->get_field_name('title'); ?>" type="text" value="<?php echo $title; ?>">
			</label>
		</p>
		<p>
			<label for="<?php echo $this->get_field_id('category'); ?>">
				<?php _e('Category Slug:', 'theme1958'); ?>
		...
		<p>
			<label for="<?php echo $this->get_field_id('post_format'); ?>">
				<?php _e('Post format:', 'theme1958'); ?><br>
		...
		<p>
			<label for="<?php echo $this->get_field_id('sort_by'); ?>">
				<?php _e('Post order:', 'theme1958'); ?><br>
