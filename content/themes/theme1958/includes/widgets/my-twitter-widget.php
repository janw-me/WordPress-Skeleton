...
class MY_TwitterWidget extends WP_Widget {
	...
	function form($instance) {
		...
		<p>
			<label for="<?php echo $this->get_field_id('twitter_name'); ?>"><?php _e('Twitter Name:', 'theme1958'); ?>
		...
		<p>
			<label for="<?php echo $this->get_field_id('twitts_amount'); ?>"><?php _e('Twitts number:', 'theme1958'); ?>
