...
function theme1958_random($length){
...
function pagination($pages = '', $range = 2){
	...
	if(1 != $pages) {
		...
		if($paged > 2 && $paged > $range+1 && $showitems < $pages) echo "<a href='".get_pagenum_link(1)."' class='first-page button hide-mp'>&laquo; First</a>";
		if($paged > 1 && $showitems < $pages) echo "<a href='".get_pagenum_link($paged - 1)."' class='prev-page button'>&lsaquo; Prev</a>";
		...
		echo '</span>';
		if ($paged < $pages && $showitems < $pages) echo "<a href=\"".get_pagenum_link($paged + 1)."\" class='next-page button'>Next &rsaquo;</a>"; 
		if ($paged < $pages-1 &&  $paged+$range-1 < $pages && $showitems < $pages) echo "<a href='".get_pagenum_link($pages)."' class='last-page button hide-mp'>Last &raquo;</a>";
		echo "</div>\n";
	}
}
