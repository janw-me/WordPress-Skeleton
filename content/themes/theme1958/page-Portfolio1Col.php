					...
					<ul class="portfolio clearfix rlist">
						<?php if ( have_posts() ) while ( have_posts() ) : the_post(); ?>
							<li>
								...
								$image = aq_resize( $img_url, 608, 393, true ); //resize & crop img
								...
								<div class="folio-desc">
									...
									<p class="excerpt"><?php $excerpt = get_the_excerpt(); echo my_string_limit_words($excerpt,100);?></p>
									<a href="<?php the_permalink() ?>" class="button"><?php _e('Read more', 'theme1958'); ?></a>
								</div>
								<div class="clear"></div>
							</li>
						<?php endwhile; ?>
